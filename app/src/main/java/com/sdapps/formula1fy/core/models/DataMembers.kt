...
object DataMembers {
    ...
    const val tbl_latestResultCols = "number,position,round_point,start_grid,total_laps,status,rank,fastest_lap,fastest_lap_time,speed_unit,fastest_lap_avg_speed"
}
